...
if singleFLAG
    ...
    for indexOBJ = 1:length(RADIUS)
        ...
        cellPIXEL = hypot(XX - xyPOS(indexOBJ,1), YY - ...
            xyPOS(indexOBJ,2)) <= RADIUS(indexOBJ);
        ...
        croppedIMG = imcrop(greenIMG, [xyPOS(indexOBJ,1)-...
            RADIUS(indexOBJ) xyPOS(indexOBJ,2)-RADIUS(indexOBJ) ...
            2*RADIUS(indexOBJ) 2*RADIUS(indexOBJ)]);
