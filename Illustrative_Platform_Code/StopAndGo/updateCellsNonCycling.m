%% updateCellsNonCycling.m
%%% OCTOBER 14, 2020

function [trackedOBJS, removedOBJS, idN] = updateCellsNonCycling(M1, ...
    ...
    for k = 1:N1
        ...
        elseif length(INDEX) > 1
            ...
            trackedOBJS(k).NucleusIdxPixel{POS} = ...
                newOBJs(sortedINDEXES(1)).NucleusIdxPixel;
            ...
            for D = 2:length(sortedINDEXES)
                ...
                if POS == 1
                    ...
                    lOBJs.Centroid = ...
                        newOBJs(sortedINDEXES(D)).Centroid;
                    ...
                    if norm([trackedOBJS(k).Centroid(end,1) trackedOBJS(k).Centroid(end,2)] - [trackedOBJS(S+1).Centroid(end,1) trackedOBJS(S+1).Centroid(end,2)]) < MAX_MOTHER_DAUGHTER_DISPACEMENT
