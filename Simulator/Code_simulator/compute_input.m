...
function [U, Theta_r] = compute_input(ITR, N, ctrl_name, Theta_r, x_out, U, sampl_time)

switch ctrl_name
    
    case 'RefOsc'
        
        [u, Theta_r_next] = ref_osc(x_out, Theta_r(ITR));
    ...
    case 'MPC'
        ...
        if mod(ITR-1, T_c)==0
            ...
            u = mpc_code(ITR, sampl_time, U, x_out(end,1:2:end), ...
                x_out(end,2:2:end), N);
