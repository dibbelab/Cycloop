...
for z = vct_nu
    ...
    if isfile(['./Output_Simulations/SFIG2_ce/closedLoop_nu' num2str(z) '_' ...
    ...
    for ITR = 1:length(tSPAN)-1
        ...
        if isnan(U(ITR))
            ...
            [U, Theta_r] = compute_input_SFIG2_ce(ITR, z, ctrl_name, ...
                Theta_r, x_out, U);
            
        end
        
        [N, t_out, x_out, lineage] = exc_odes(N, ts_i, ts_f, U(ITR,:), ...
    ...
    save(['./Output_Simulations/SFIG2_ce/closedLoop_nu' num2str(z) ...
        '_' strain_mod '_' ctrl_name '_.mat'], 't_out', 'x_out')
...
for z = 1:numel(vct_nu)
    ...
    if ~isfile(['./Output_Simulations/SFIG2_ce/closedLoop_nu' ...
            num2str(vct_nu(z)) '_' strain_mod '_' ctrl_name '_.mat'])
    ...
    load(['./Output_Simulations/SFIG2_ce/closedLoop_nu' ....
        num2str(vct_nu(z)) '_' strain_mod '_' ctrl_name '_.mat'], ...
        't_out', 'x_out');
...
%% Print figure SFIG2_ce
print(F, './Figures/SFIG2_ce', '-dpng');
