...
for z = vctT
    ...
    for q = vctP
        ...
        disp(['I am simulating T = ', num2str(z), ...
            ...
            if isfile(['./SFIG2_MAT_/openLoop_T' num2str(z) '_P' ...
        ...
        for ITR = 1:length(tSPAN)-1
            ...
            if isnan(U(ITR))
                ...
                [U, Theta_r] = ComputePulse_(ITR, z, q, ...
        ...
        save(['./SFIG2_MAT_/openLoop_T' num2str(z) '_P' num2str(q) ...
...
for z = 1:numel(vctT)
    ...
    for q = 1:numel(vctP)
        ...
        disp(['I am analysing T = ', num2str(vctT(z)), ...
            ...
            if ~isfile(['./SFIG2_MAT_/openLoop_T' num2str(vctT(z)) '_P' ...
        ...
        load(['./SFIG2_MAT_/openLoop_T' num2str(vctT(z)) '_P' num2str(vctP(q)) ...
            '_' strain_mod '_' ctrl_name '_'], 't_out', 'x_out');
...
print(F, './Images/SFIG2bc_', '-dsvg');
print(F, './Images/SFIG2bc_', '-dpng');